...
// --- PropertyRemarksModal Component ---
// A modal to display the remarks for a specific property.
const PropertyRemarksModal = ({ isOpen, onClose, property, onGetRemarks }) => {
  ...
  useEffect(() => {
    if (isOpen && propertyId && onGetRemarks) {
      fetchRemarks();
    }
  }, [isOpen, propertyId]);
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        <div className="p-4 border-b flex justify-between items-center">
          <h2 className="text-lg font-bold text-gray-800">
            Remarks for: <span className="text-blue-600">{property.propertyName || property.name}</span>
          </h2>
        ...
        <div className="p-4 overflow-y-auto">
          {loading ? (
            ...
            <p className="text-center text-gray-500 py-8">No remarks found for this property.</p>
          ) : (
